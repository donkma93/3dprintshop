...
class CmsSeeder extends Seeder
{
    public function run(): void
    {
        SiteSetting::setMany([
            ...
            'meta_description' => 'Shop3DPrinting — Tận tâm - từ tấm lòng. Chuyên in 3D mô hình, phụ kiện, quà tặng doanh nghiệp. Nhận thiết kế theo yêu cầu, giao hàng toàn quốc.',
            'meta_keywords' => 'in 3D, Shop3DPrinting, sản phẩm in 3D, mô hình 3D, quà tặng in 3D, PLA, PETG, resin',
            'phone' => '0901 234 567',
        ...
        Page::updateOrCreate(
            ...
            [
                'title' => 'Giới thiệu',
                'content' => "Shop3DPrinting là đơn vị chuyên in 3D sản phẩm mô hình, quà tặng và chi tiết kỹ thuật.\n\nChúng tôi sử dụng máy in FDM và Resin, đa dạng vật liệu PLA, PETG, ABS, Resin.\nCam kết chất lượng, tiến độ và hỗ trợ khách hàng trong suốt quá trình đặt hàng.",
                'meta_title' => 'Giới thiệu Shop3DPrinting | Xưởng in 3D chuyên nghiệp',
                'meta_description' => 'Tìm hiểu về Shop3DPrinting – xưởng in 3D mô hình, quà tặng doanh nghiệp và chi tiết kỹ thuật.',
        ...
        Page::updateOrCreate(
            ...
            [
                ...
                'meta_title' => 'Liên hệ Shop3DPrinting | Tư vấn & báo giá in 3D',
                'meta_description' => 'Liên hệ Shop3DPrinting để tư vấn vật liệu, báo giá in 3D và đặt hàng theo yêu cầu.',
        ...
        Page::updateOrCreate(
            ...
            [
                ...
                'meta_title' => 'Chính sách bảo hành | Shop3DPrinting',
                'meta_description' => 'Chính sách bảo hành, đổi trả sản phẩm in 3D tại Shop3DPrinting.',
                'is_published' => true,
                'show_in_menu' => true,
                'sort_order' => 3,
            ]
        ...
        Post::updateOrCreate(
            ...
            [
                ...
                'meta_title' => 'Quy trình đặt hàng in 3D | Shop3DPrinting',
                'meta_description' => 'Tìm hiểu quy trình đặt hàng in 3D nhanh gọn tại Shop3DPrinting.',
